#!/bin/bash
#
# This script cleans up the objects created by the deploy of jira-manifest.json
#
...
echo "Deleting jobs ..."
apc job delete --batch jira

echo "Deleting services ..."
apc service delete --batch jira-data
apc service delete --batch jira-mysql
